 ...
 */
export const getPrivateChatPolicy = <ThrowOnError extends boolean = false>(options: Options<GetPrivateChatPolicyData, ThrowOnError>) => (options.client ?? client).get<GetPrivateChatPolicyResponses, GetPrivateChatPolicyErrors, ThrowOnError>({ url: '/organizations/{organization_id}/private-chat-policy', ...options });

/**
 * PUT /organizations/{organization_id}/private-chat-policy
 */
export const updatePrivateChatPolicy = <ThrowOnError extends boolean = false>(options: Options<UpdatePrivateChatPolicyData, ThrowOnError>) => (options.client ?? client).put<UpdatePrivateChatPolicyResponses, UpdatePrivateChatPolicyErrors, ThrowOnError>({
