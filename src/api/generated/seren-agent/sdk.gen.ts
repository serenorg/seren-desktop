 ...
 * deployment revision.
 */
export const serenAgentApplyRuntimePolicyReconciliation = <ThrowOnError extends boolean = false>(options: Options<SerenAgentApplyRuntimePolicyReconciliationData, ThrowOnError>): RequestResult<SerenAgentApplyRuntimePolicyReconciliationResponses, SerenAgentApplyRuntimePolicyReconciliationErrors, ThrowOnError> => (options.client ?? client).post<SerenAgentApplyRuntimePolicyReconciliationResponses, SerenAgentApplyRuntimePolicyReconciliationErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const serenAgentPreviewRuntimePolicyReconciliation = <ThrowOnError extends boolean = false>(options: Options<SerenAgentPreviewRuntimePolicyReconciliationData, ThrowOnError>): RequestResult<SerenAgentPreviewRuntimePolicyReconciliationResponses, SerenAgentPreviewRuntimePolicyReconciliationErrors, ThrowOnError> => (options.client ?? client).post<SerenAgentPreviewRuntimePolicyReconciliationResponses, SerenAgentPreviewRuntimePolicyReconciliationErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
