 ...
 */
export const serenAgentDeployMutation = (options?: Partial<Options<SerenAgentDeployData>>): MutationOptions<SerenAgentDeployResponse, SerenAgentDeployError, Options<SerenAgentDeployData>> => {
    const mutationOptions: MutationOptions<SerenAgentDeployResponse, SerenAgentDeployError, Options<SerenAgentDeployData>> = {
 ...
 */
export const serenAgentTestRunMutation = (options?: Partial<Options<SerenAgentTestRunData>>): MutationOptions<SerenAgentTestRunResponse, SerenAgentTestRunError, Options<SerenAgentTestRunData>> => {
    const mutationOptions: MutationOptions<SerenAgentTestRunResponse, SerenAgentTestRunError, Options<SerenAgentTestRunData>> = {
        mutationFn: async (fnOptions) => {
